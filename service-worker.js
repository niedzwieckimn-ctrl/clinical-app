const CACHE='clinical-spa-v12';
const CORE=['/','/index.html','/assets/style.css','/assets/admin.js','/assets/logo.svg','/assets/botanical.svg','/manifest.webmanifest','/assets/icons/icon-v4-192.png','/assets/icons/icon-v4-512.png','/assets/icons/maskable-v4-512.png'];
