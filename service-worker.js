const CACHE='clinical-spa-secure-v12';
const CORE=['/','/index.html','/client.html','/assets/style.css','/assets/admin.js','/assets/booking-range.js','/assets/admin-booking.js','/assets/admin-booking.css','/assets/clients.js','/assets/finance.js','/assets/cosmetics.js','/assets/client-details.js','/assets/supabase-client.js','/assets/logo.svg','/assets/botanical.svg','/manifest.webmanifest','/assets/icons/icon-v3-192.png','/assets/icons/icon-v3-512.png','/assets/icons/maskable-v3-512.png'];
