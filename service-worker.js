const CACHE='clinical-spa-v2';
const CORE=['/','/index.html','/assets/style.css','/assets/admin.js','/assets/logo.svg','/manifest.webmanifest','/assets/icons/icon-192.png','/assets/icons/icon-512.png'];
